...
\noindent
\note{The experimental results of this work are still work in progress. Unfortunately, due to a
series of misadventures experienced at the hardware level, the quantum physical layer has been
unavailable for an extended period of time, causing unexpected delays for the final
\acrshort{qnodeos} experiments. We hope to be ready with these results soon, and include them in the
next version of this dissertation. The evaluation section of this chapter is largely a boilerplate
...
\noindent
\note{Main discussion to be added after experiments are performed}

Some other discussion and gluing material...
