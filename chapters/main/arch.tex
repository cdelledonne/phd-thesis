...
same system, potentially enabling some performance optimizations, at the cost of a higher system
...
separate device (refer to \cref{sec:implementation} for details).
