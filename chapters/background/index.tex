...
\note{To be precise, this chapter is extracted from sections 1 (Introduction), 2 (Background on
    Quantum Networking) and 3.1 (Challenges) from the QNodeOS paper. There aren't any major additions.}
...
Up to now, demonstrations of quantum networking beyond QKD focused on hardware realizations.
