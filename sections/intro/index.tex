...
\blfootnote{
    This chapter is partly based on \faFileTextO~\emph{M. Beller. Toward an Empirical Theory of
    Feedback-Driven Development, ICSE'18 (Student Research Competition)}~\cite{BellerSRC2018}.
}
...
In this thesis, you can reference pictures~\Cref{fig:devmodel} using Cleverref and circles
\circled{5}.
...
%     \caption{
%         The stages of the FDD model and their relationship to other Software Engineering concepts.
%     }
%     \label{fig:devmodel}
% \end{figure}
...
\begin{enumerate}
    \item Static Analysis~\circled{3} examines program artifacts or their source code without
